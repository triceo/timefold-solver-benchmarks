...
public enum Example {
    ...
    CONFERENCE_SCHEDULING(ConferenceSchedulingProblem::new, ScoreDirectorType.CONSTRAINT_STREAMS, ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    CURRICULUM_COURSE(CurriculumCourseProblem::new, ScoreDirectorType.CONSTRAINT_STREAMS, ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    EXAMINATION(ExaminationProblem::new, ScoreDirectorType.CONSTRAINT_STREAMS, ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    FLIGHT_CREW_SCHEDULING(FlightCrewSchedulingProblem::new, ScoreDirectorType.CONSTRAINT_STREAMS, ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    ...
    MEETING_SCHEDULING(MeetingSchedulingProblem::new, ScoreDirectorType.CONSTRAINT_STREAMS, ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    NURSE_ROSTERING(NurseRosteringProblem::new, ScoreDirectorType.CONSTRAINT_STREAMS, ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    PATIENT_ADMISSION_SCHEDULING(PatientAdmissionSchedulingProblem::new, ScoreDirectorType.CONSTRAINT_STREAMS,
            ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    PROJECT_JOB_SCHEDULING(ProjectJobSchedulingProblem::new, ScoreDirectorType.INCREMENTAL, ScoreDirectorType.CONSTRAINT_STREAMS,
            ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    TASK_ASSIGNING(TaskAssigningProblem::new, ScoreDirectorType.CONSTRAINT_STREAMS, ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    TENNIS(TennisProblem::new, ScoreDirectorType.CONSTRAINT_STREAMS, ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    TRAVELING_TOURNAMENT(TravelingTournamentProblem::new, ScoreDirectorType.CONSTRAINT_STREAMS, ScoreDirectorType.CONSTRAINT_STREAMS_JUSTIFIED),
    TSP(TspProblem::new),
